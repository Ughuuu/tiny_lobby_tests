...
class GameThread {
   ...
   public:
    ...
    void on_error(std::string command_id, std::string peer_id, std::string message,
    ...
    void set_lobby_sealed(LobbyData &lobby, std::string peer_id, std::string command_id,
                          bool sealed);
