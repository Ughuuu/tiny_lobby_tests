...
.\vcpkg install efsw --disable-metrics --triplet x64-windows-static
.\vcpkg install "libdeflate[compression,decompression,zlib]" --disable-metrics --triplet x64-windows-static
.\vcpkg install "uwebsockets[libdeflate]" --disable-metrics --triplet x64-windows-static
