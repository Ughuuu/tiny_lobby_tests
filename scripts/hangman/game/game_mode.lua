...
function GameMode:on_timer_next_word(lobby_data) error("on_timer_next_word not implemented") end
function GameMode:on_timer_kick_peer(lobby_data, peerID) error("on_timer_kick_peer not implemented") end
...
function GameMode:on_timer_broadcast_remaining_time(lobby_data) error("on_timer_broadcast_remaining_time not implemented") end
function GameMode:on_timer_start_game(lobby_data) error("on_timer_start_game not implemented") end
function GameMode:set_initial_data(lobby_data) error("set_initial_data not implemented") end
function GameMode:on_tick(lobby_data, tickrate) error("on_tick not implemented") end
...
function GameMode:on_ready(lobby_data) error("on_ready not implemented") end
